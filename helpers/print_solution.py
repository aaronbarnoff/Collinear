...
def plot_solution(points, collinear_list, n, k, dimacs_file):
    ...
    pts_src = points_k7_upper_symmetric if k == 7 else points_k6_upper_symmetric
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Solution k={k}, n={n}', fontsize=16)

...
def encode_boundary_constraints():
    ...
    points_k7_upper_bounds_symmetric = """
        ...
        (167,86),(168,87),(170,88),(171,89),      (90,172), (172,90),   (91, 174), (174, 91)
    """
    ...
    points_k7_upper_bounds = """
        ...
        (81,159),(82,162),(83,163),(84,165),(85,166),(86,167),(87,168),(88,170),   (89,171),     (90, 172),     (91, 174)
    """
    ...
    points_k7_lower_bounds = """
        ...
        (165,85),(165,86),(166,87),(168,88),(169,89),(171,90),(172,91),   (174,92),         (175,93),   (176,94),      (179, 95)
    """
